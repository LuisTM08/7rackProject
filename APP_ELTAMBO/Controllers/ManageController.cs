...
#region Aplicaciones auxiliares
        ...
        [HttpPost]
        public ActionResult CreateCategoria(Categoria a)
        {
            ViewBag.listarEstado = new SelectList(util.listarEstados(), "idCombo", "Descripcion");
            
            if (ModelState.IsValid)
            {
                cat.insertCategoria(a);
        ...
        {
            ViewBag.listarEstado = new SelectList(util.listarEstados(), "idCombo", "Descripcion");
            return View(cat.buscarCategoriaID(id));
        }
        [HttpPost]
        public ActionResult EditCategoria(Categoria a)
        {
            ViewBag.listarEstado = new SelectList(util.listarEstados(), "idCombo", "Descripcion");
            if (ModelState.IsValid)
            {
                cat.updateCategoria(a);
                return RedirectToAction("ListaCategorias");
            }
            return View();
        }
        ...
        public ActionResult DeleteCategoriaConfirmar(int id)
        {
            if (ModelState.IsValid)
            {
                Categoria tmp = new Categoria();
                tmp.IdCategoria = id;
                cat.deleteCategoria(tmp);
                return RedirectToAction("ListaCategorias");
            }
            return View();
